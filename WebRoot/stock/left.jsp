							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td  class="left1">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a id="exp51" title="折叠" href="javascript:widgets.ToggleWidget(hideTop1);">库存管理</a>
									</td>
								</tr>
							 </table>		
						</td>
				        ...
				        <td class="left2" >
							<div id="hideTop1" class="hiderScroll" img="exp5" openAlt="折叠" closedAlt="展开">
								<table width="100%"  border="0" cellspacing="1" cellpadding="0">
									 ...
									 <tr>
						              	<td width="16%">
						              		<div align="right"><img src="<%=basePath%>/image/dot1.gif" width="13" height="16"></div>
						              	</td>
						              	<td width="84%">
						              		<a href="<%=basePath%>/stock/order2001.jsp" target="main">入库管理</a>
						              	</td>
						            </tr>
									<tr>
						              	<td width="16%">
						              	...
						              	<td width="84%">
						              		<a href="<%=basePath%>/outOrder/findAll.action" target="main">出库管理</a>
						              	</td>
						            </tr>
		    ...
		    <td valign="top" class="left"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
		      ...
		      <tr>
				...
				<table width="100%"  border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
		              <td width="16%"><div align="right"><img src="<%=basePath%>/image/dot1.gif" width="13" height="16"></div></td>
		              <td width="84%"><a href="<%=basePath%>/stock/order3001.jsp" target="main">出库管理</a></td>
		            </tr>
...
>>>>>>> 6810c048c003bb3b25d962bd48e5dbd4d32a3a51
  </body>
</html>
